...
import com.example.Tarea2_4_Aplicacion_Firma_Digital.Clase.Signatures;

import java.util.List;

public class ListAdapter extends ArrayAdapter {

    private List<Signatures> mLista;
    private Context context;
    private int resourceLayout;

    public ListAdapter(@NonNull Context context, int resource, @NonNull List<Signatures> objects) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        Signatures modelo = mLista.get(position);
